  ...
  return (
    <>
      ...
      <nav className="bg-stone-100 border-b border-stone-200 py-3" aria-label="Breadcrumb">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center gap-2 text-xs text-stone-500 font-semibold tracking-wide uppercase">
      ...
      <section className="bg-stone-900 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-wrap items-center gap-3 mb-5">
            ...
            <span className="text-xs font-bold tracking-widest uppercase px-3 py-1 bg-stone-700 text-stone-200">
              {project.category}
            </span>
          </div>
      ...
      {/* Image Placeholder */}
      <div className="h-80 sm:h-96 bg-gradient-to-br from-stone-200 to-stone-300 relative flex items-center justify-center overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2 space-y-10">
              {/* Highlights */}
              <div>
                <h2 className="text-2xl font-black text-stone-900 uppercase tracking-tight mb-6">
                  Project Highlights
                </h2>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {related.map((p) => (
                ...
                >
                  <div className="w-16 h-16 bg-stone-100 flex items-center justify-center flex-shrink-0 text-2xl group-hover:bg-amber-50 transition-colors">
                    {p.category === 'Commercial' ? '🏢' : '🏠'}
                  </div>
                  <div>
                    <div className="text-xs text-amber-700 font-bold tracking-widest uppercase mb-1">
                      {p.category} · {p.year}
                    </div>
                    <div className="font-bold text-stone-900 uppercase tracking-wide text-sm group-hover:text-amber-700 transition-colors mb-1">
                      {p.name}
                    </div>
